const CACHE_NAME = "garage-stock-16-11";
...
const ASSETS = [
  ...
  "./style.css?v=16.11",
  "./js/core.js?v=16.11",
  "./js/inventory.js?v=16.11",
  "./js/sales-dashboard.js?v=16.11",
  "./js/staff.js?v=16.11",
  "./js/sales.js?v=16.11",
  "./js/requests.js?v=16.11",
  "./js/surveys.js?v=16.11",
  "./js/management.js?v=16.11",
  "./js/purchasing.js?v=16.11",
  "./js/navigation-v16.11.js?v=16.11",
  "./js/reports.js?v=16.11",
  "./js/migration-api.js?v=16.11",
  "./js/search-tools.js?v=16.11",
  "./js/events.js?v=16.11",
  "./js/excel.js?v=16.11",
  "./js/migration-excel.js?v=16.11",
  "./app.js?v=16.11",
  "./manifest.webmanifest?v=16.11",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
    ...
    if (isUpgrade) {
      ...
      await Promise.all(windows.map(async (client) => {
        try {
          ...
          url.searchParams.set("__garage_build", "16.11");
...
self.addEventListener("fetch", (event) => {
  ...
  // v16.11: Cache-first tamamen kaldırıldı.
