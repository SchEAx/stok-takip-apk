...
window.reserveProductForRequest = async function() { throw new Error("VDS API yüklenmeden rezervasyon yapılamaz."); };
window.cancelReservation = async function() { throw new Error("VDS API yüklenmeden rezervasyon iptal edilemez."); };
